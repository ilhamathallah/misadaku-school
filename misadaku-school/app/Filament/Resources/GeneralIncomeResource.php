...
{
    protected static ?string $pluralModelLabel = 'Pemasukan non tagihan';
    ...
    protected static ?string $modelLabel = 'Pemasukan non tagihan';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                TextInput::make('name')->label('Nama Pemasukan')->required()->afterStateUpdated(function ($state, callable $set) {
                    $set('name', ucfirst($state)); // bikin huruf pertama kapital
                }),
                DatePicker::make('income_date')->label('Tanggal')->native(false)->required(),
